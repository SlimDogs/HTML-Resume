	...
	public translations = {
		...
		"lt": {
			...
			"wersportsDescription": `"We R Sports" tai vienos šeimos įkurtas, internetinę prekybą pagrįstas, verslas. Kompanija internetu prekiauja sporto įranga ir atributika.
					...
					<br><br>
					Taipogi į mano pareigas įėjo naujienlaiškių kūrimas, bei SEO implementacijos ("Schema.org" žymių diegimas). Taip pat teko dirbti su "Google Adwords", "Google Webmaster Tools".`,
			...
			"gvcDescription": `"GVC Digital" nedidelė kompanija, kuri specializuojasi elektroninių prekių perpardavime internetu. Kompanija turi keletą internetinių parduotuvių, bei gausybę parduotuvių populiariausiuose pardavimo kanaluose, tokiuose kaip eBay, Amazon ir t.t. Tuo metu aš buvau vienintelis programuotojas dirbantis kompanijoje.
					<br><br>
					Mano pagrindinė pareiga buvo užtikriti, kad visos pardavimų platformos turėtų naujausius produktų duomenis. Kadangi "GVC Digital" užsiminėjo perpardavimais ir realių prekių savo sandėliuose neturėjo - buvo labai svarbu pastoviai atnaujinti produktų informaciją (kiekius, kainas ir t.t.), kad pirkėjai neįsigytų prekių, kurių tiekėjai jau nebeturėjo... Pasinaudodamas C# programavimo kalba, sukūriau programėlę, kuri automatiškai rinko duomenis iš prekių tiekėjų, juos konvertavo į atitinkamus failų formatus, kuriuos vėliau buvo galima importuoti į duomenų bazes.
					<br><br>
			...
			"freeDescrption": `Šiuo laikotarpiu teko dirbti prie įvairiausių projektų, bei teikti įvairias paslaugas: nuo svetainių talpinimo paieškos iki pilno svetainės kūrimo.
					<br><br>
					Teko sukurti ne vieną blogą, naujienų puslapį: turiniui valdyti pritaikydavau įvairius sprendimus, tokius kaip "WordPress", "CuteNews" ar "PHP Nuke".
					<br><br>
					Dažnai tobulindavau jau egzistuojančius projektus: diegdavau diskusijų lentas, svečių knygas, vartotojų lankomumo skaitliukus.`,
