class LanguageSwitch implements Resume_Application.ILanguageSwitch {
	public translations = {
		...
		"lt": {
			...
			"freeDescrption": `Šiuo laikotarpiu teko dirbti prie įvairiausių projektų, bei teigti įvairias paslauga: nuo svetainių talpinimo paieškos iki pilno svetainės kūrimo nuo nulio.
					<br><br>
